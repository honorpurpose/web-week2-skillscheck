...
const groceries = ['bananas', 'tacos', 'apples']
...
const checkGroceryCount = () => {
    return groceries.length >= 5 ? 'That looks like a big trip' : groceries.length === 1 ? '1 item' : groceries.length + ' items'
}
